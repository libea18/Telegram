    ...
    static const TlsHello &getDefault() {
        static TlsHello result = [] {
            ...
            res.ops = {
                    ...
                    Op::string("\x00\x36", 2),
                    Op::grease(0),
                    Op::string("\x13\x01\x13\x02\x13\x03\xc0\x2c\xc0\x2b\xcc\xa9\xc0\x30\xc0\x2f\xcc\xa8\xc0\x24"
                                   "\xc0\x23\xc0\x0a\xc0\x09\xc0\x28\xc0\x27\xc0\x14\xc0\x13\x00\x9d\x00\x9c\x00\x3d\x00\x3c\x00\x35\x00\x2f\xc0\x08\xc0\x12\x00\x0a\x01\x00\x01\x7d", 56),
                    Op::grease(2),
                    ...
                    Op::end_scope(),
                    Op::end_scope(),
                    Op::string("\x00\x17\x00\x00\xff\x01\x00\x01\x00\x00\x0a\x00\x0c\x00\x0a", 15),
                    Op::grease(4),
                    Op::string(
                               "\x00\x1d\x00\x17\x00\x18\x00\x19\x00\x0b\x00\x02\x01\x00\x00\x10\x00\x0e\x00\x0c\x02\x68\x32\x08\x68\x74"
                                   "\x74\x70\x2f\x31\x2e\x31\x00\x05\x00\x05\x01\x00\x00\x00\x00\x00\x00\x0d\x00\x18\x00\x16\x04\x03\x08\x04"
                                   "\x04\x01\x05\x03\x02\x03\x08\x03\x02\x03\x08\x05\x08\x05\x05\x01\x08\x06\x01\x02\x01\x00\x12\x00\x00\x00\x33\x00\x2b\x00\x29", 83),
                    Op::grease(4),
                    Op::string("\x00\x01\x00\x00\x1d\x00\x20", 7),
                    Op::K(),
                    Op::string("\x00\x2d\x00\x02\x01\x01\x00\x2b\x00\x0b\x0a", 11),
                    Op::grease(6),
                    Op::string("\x03\x04\x03\x03\x03\x02\x03\x01", 5),
                    Op::grease(3),
