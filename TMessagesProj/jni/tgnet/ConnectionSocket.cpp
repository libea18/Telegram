    ...
    static const TlsHello &getDefault() {
        static TlsHello result = [] {
            ...
            res.ops = {
                    ...
                    Op::string("\x20", 1),
                    Op::random(32),
                    Op::string("\x00\x22\x13\x01\x13\x03\x13\x02\xc0\x2b\xc0\x2f\xcc\xa9\xcc\xa8\xc0\x2c\xc0\x30\xc0\x0a"
                               "\xc0\x09\xc0\x13\xc0\x14\x00\x9c\x00\x9d\x00\x2f\x00\x35\x01\x00\x01\x91\x00\x00\x00", 43),
                    Op::grease(2),
                    Op::string("\x00", 1),
                    Op::begin_scope(),
                    Op::begin_scope(),
                    ...
                    Op::end_scope(),
                    Op::end_scope(),
                    Op::string("\x00\x17\x00\x00\xff\x01\x00\x01\x00\x00\x0a\x00\x0e\x00\x0c"
                               "\x00\x1d\x00\x17\x00\x18\x00\x19\x01\x00\x01\x01\x00\x0b\x00\x02\x01\x00\x00\x23\x00\x00\x00\x10\x00\x0e"
                               "\x00\x0c\x02\x68\x32\x08\x68\x74\x74\x70\x2f\x31\x2e\x31\x00\x05\x00\x05\x01\x00\x00\x00\x00\x22\x00\x0a"
                               "\x00\x08\x04\x03\x05\x03\x06\x03\x02\x03\x00\x33\x00\x6b\x00\x69\x00\x1d\x00\x20", 87),
                    Op::K(),
                    Op::string("\x00\x17\x00\x41\x04", 5),
                    Op::random(64),
                    Op::string("\x00\x2b\x00\x05\x04\x03\x04\x03\x03\x00\x0d\x00\x18\x16\x04\x03\x05\x03\x06\x03\x08\x04\x08\x05\x08"
                               "\x06\x04\x01\x05\x01\x06\x01\x02\x03\x02\x01\x00\x2d\x00\x02\x01\x01\x00\x1c\x00\x02\x40\x01\x00\x15", 50)};
            return res;
        }();
        return result;
    }
